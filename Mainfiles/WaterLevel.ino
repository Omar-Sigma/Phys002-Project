...
/*conth*/ int conth = 0 ; // Depth of the container
/*sensh*/ int sensh = 0 ;  // Distance from the sensor to the tip of the container
/*maxl*/  int maxl  = 0 ;  // If this waterlevel is reached, a certain action will be done
